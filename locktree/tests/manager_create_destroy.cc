...
void manager_unit_test::test_create_destroy(void) {
    ...
    invariant(mgr.m_escalation_stats.m_escalation_count == 0);
    invariant(mgr.m_escalation_stats.m_escalation_time == 0);
    invariant(mgr.m_escalation_stats.m_escalation_latest_result == 0);
