...
void lock_request_unit_test::test_get_set_keys(void) {
    ...
    request.set(null_lt, txnid_a, neg_inf, pos_inf, lock_request::type::WRITE, nullptr, false);
    ...
    request.set(null_lt, txnid_a, neg_inf, one, lock_request::type::WRITE, nullptr, false);
    invariant(request.get_left_key() == neg_inf);
    invariant(request.get_right_key() == one);

    request.set(null_lt, txnid_a, two, pos_inf, lock_request::type::WRITE, nullptr, false);
    invariant(request.get_left_key() == two);
    invariant(request.get_right_key() == pos_inf);

    request.set(null_lt, txnid_a, one, two, lock_request::type::WRITE, nullptr, false);
